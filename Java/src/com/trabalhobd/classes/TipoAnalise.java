...
public class TipoAnalise{
	...
	public TipoAnalise(TipoAnalise a) {
		this.tipoanalise_id = a.getTipoanalise_id();
		this.tipo = a.getTipo();
	}
	...
	public String toString() {
		return "TipoAnalise [tipoanalise_id=" + tipoanalise_id + ", tipo="
				+ tipo + "]";
	}

	public TipoAnalise clone() {
		return new TipoAnalise(this);
	}
